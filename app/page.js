...
export default function Page() {
  ...
  return (
    <div style={{background:C.bg,color:C.light,fontFamily:"'DM Sans',sans-serif"}}>
      ...
      {/* HERO */}
      <section ref={h} className="hw" style={{position:'relative',width:'100%',height:'100vh',overflow:'hidden',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:`radial-gradient(ellipse at 50% 40%,rgba(200,163,72,.12) 0%,${C.bg} 55%)`}}>
        <div style={{position:'absolute',inset:0,background:`linear-gradient(180deg,transparent 0%,rgba(10,10,8,.4) 70%,${C.bg} 100%)`,zIndex:1}}/>
      ...
      <section id="experience" style={{position:'relative',padding:'140px clamp(24px,5vw,80px)',overflow:'hidden'}}>
        <div className="sbg" style={{backgroundImage:'url(/logo.png)',backgroundPosition:'80% center',backgroundSize:'35%',opacity:.04,filter:'brightness(.25)'}}/>
      ...
      <section style={{position:'relative',background:'#0D0D0A',padding:'120px clamp(24px,5vw,80px)',overflow:'hidden'}}>
        <div className="sbg" style={{backgroundImage:'url(/logo.png)',backgroundPosition:'10% center',backgroundSize:'28%',opacity:.03,filter:'brightness(.25)'}}/>
      ...
      <section id="tickets" style={{position:'relative',padding:'160px clamp(24px,5vw,80px)',overflow:'hidden'}}>
        <div className="sbg" style={{backgroundImage:'url(/logo.png)',backgroundPosition:'center',backgroundSize:'30%',opacity:.04,filter:'brightness(.25)'}}/>
